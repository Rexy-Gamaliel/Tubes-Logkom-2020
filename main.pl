...
initJob(Username, Job) :-
    ...
    (
        ...
        Job =:= 1 ->
            ...
            asserta(playerInfo(Username, swordsman, 0, 21, playerStatus(100, 100, 50, 100, 100, 50, 3, 3, 1, 14, 4))),
            asserta(gold(30000));
...
help :-
    ...
    write('     infoItem    --      menampilkan detail suatu item'),nl,
    write('     equip       --      menggunakan suatu item'),nl,
    write('     throwItem   --      membuang suatu item'),nl,
